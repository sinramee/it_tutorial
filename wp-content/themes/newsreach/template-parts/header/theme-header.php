...
$enable_header_bg_overlay = newsreach_get_option('enable_header_bg_overlay');
$header_image_size = newsreach_get_option('header_image_size');
$enable_top_bar = newsreach_get_option('enable_top_bar');
