 ...
 * @package Newsreach
 */
$ed_header_type = newsreach_get_option( 'ed_header_type' );
$upload_add_image = newsreach_get_option( 'upload_add_image' );
$ed_header_link = newsreach_get_option( 'ed_header_link' );
$advertisement_section_title = newsreach_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'newsreach') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
