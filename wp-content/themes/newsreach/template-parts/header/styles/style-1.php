...
$upload_header_add_image = newsreach_get_option('upload_header_add_image');
$ad_header_banner_link = newsreach_get_option('ad_header_banner_link');
        ...
        <div class="site-header-wrapper">
            ...
            <div class="site-header-right">
                ...
                <?php if ($enable_dark_mode && $enable_dark_mode_switcher) : ?>
                    <button id="theme-toggle-mode-button" class="theme-button theme-button-transparent theme-button-colormode" title="<?php _e('Toggle light/dark mode', 'newsreach'); ?>" aria-label="auto" aria-live="polite">
