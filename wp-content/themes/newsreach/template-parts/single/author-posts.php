...
$author_posts_text = newsreach_get_option('author_posts_text');
$no_of_author_posts = absint(newsreach_get_option('no_of_author_posts'));
$order = esc_attr(newsreach_get_option('author_posts_order'));
$orderby = esc_attr(newsreach_get_option('author_posts_orderby'));
