...
$related_posts_text = newsreach_get_option('related_posts_text');
$no_of_related_posts = absint(newsreach_get_option('no_of_related_posts'));
$order = esc_attr(newsreach_get_option('related_posts_order'));
$orderby = esc_attr(newsreach_get_option('related_posts_orderby'));
