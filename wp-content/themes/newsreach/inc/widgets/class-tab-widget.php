...
class Newsreach_Tab_Posts extends Newsreach_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_newsreach_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'newsreach');
        $this->widget_id = 'newsreach_tab_posts';
        $this->widget_name = __('Newsreach: Tab Posts', 'newsreach');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'newsreach'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'newsreach'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'newsreach'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'newsreach'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'newsreach'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'newsreach'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'newsreach'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'newsreach'),
                'type' => 'select',
                'default' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'newsreach'),
                    'medium' => esc_html__('Medium', 'newsreach'),
                    'large' => esc_html__('Large', 'newsreach'),
                    'full' => esc_html__('Full', 'newsreach'),
                ),
            ),
            'style' => array(
                'type' => 'select',
