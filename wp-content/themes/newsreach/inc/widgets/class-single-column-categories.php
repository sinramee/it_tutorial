...
class Newsreach_Single_Column_Categories extends Newsreach_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'newsreach_single_column_widget';
        $this->widget_description = __("Displays Single colum with multiple category widget", 'newsreach');
        $this->widget_id = 'newsreach-single-column-widget';
        $this->widget_name = __('Newsreach: Single Category', 'newsreach');
        $this->settings = array(
            'title_1' => array(
                'type' => 'text',
                'label' => __('Title', 'newsreach'),
                'std' => __('Single Category Posts Widget', 'newsreach'),
            ),
